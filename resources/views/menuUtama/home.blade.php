        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="post-media wow fadeIn">
                    <img src="menuHome/images/about_02.jpg" alt="" class="img-fluid img-rounded">
                </div><!-- end media -->
            </div><!-- end col -->
        </div>
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                <div class="post-media wow fadeIn">
                    <img src="menuHome/images/about_03.jpg" alt="" class="img-fluid img-rounded">
                </div><!-- end media -->
            </div><!-- end col -->
...
<div id="testimonials" class="parallax section db parallax-off" style="background-image:url('menuHome/images/parallax_04.jpg');">
    <div class="container">
                ...
                <div class="testi-carousel owl-carousel owl-theme">
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="menuHome/images/testi_01.png" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="menuHome/images/testi_02.png" alt="" class="img-fluid">
                    ...
                    <div class="testimonial clearfix">
                        <div class="testi-meta">
                            <img src="menuHome/images/testi_03.png" alt="" class="img-fluid ">
                            <h4>Venanda Mercy </h4>
                        </div>
                        <div class="desc">
