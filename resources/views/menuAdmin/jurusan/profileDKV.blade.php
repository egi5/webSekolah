...
<div class="card" style="width: 80rem;">
    <div class="card-header">
        <div class="row justify-content-between">
            ...
            <div class="col-4 text-center">
                <h3 style="color: #566573;">Edit Jurusan Desain Komunikasi Visual</h3>
            </div>
    ...
    <div class="card-body">
        <form  method="POST" action="profileDKV/{{ $jurusan->id }}" id="form" enctype="multipart/form-data">
            @method('PUT')
            {{ csrf_field() }}
...
<script>
    $('#isi').summernote({
      placeholder: "Silahkan tulis isi info Desain Komunikasi Visual",
      tabsize:2,
      height:300
    });
</script>
