...
<div class="card" style="width: 80rem;">
    <div class="card-header">
        <div class="row justify-content-between">
            ...
            <div class="col-4 text-center">
                <h3 style="color: #566573;">Edit Jurusan Teknik Elektro</h3>
            </div>
    ...
    <div class="card-body">
        <form  method="POST" action="profileTE/{{ $jurusan->id }}" id="form" enctype="multipart/form-data">
            @method('PUT')
            {{ csrf_field() }}
...
<script>
    $('#isi').summernote({
      placeholder: "Silahkan tulis isi info Teknik Elektro",
      tabsize:2,
      height:300
    });
</script>
